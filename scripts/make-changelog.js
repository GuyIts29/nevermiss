...
const rows = [
  ...
  },
  {
    Date: '2026-04-29',
    Time: '00:00',
    'Screen / File': 'src/services/exportService.ts',
    'Change Description': 'BL-025 (Sprint 4): New exportContactsToCSV() using PapaParse. Exports all Contact fields to CSV with UTF-8 BOM for Hebrew Excel compatibility. Downloads as nevermiss-contacts-YYYY-MM-DD.csv.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:00',
    'Screen / File': 'src/screens/SettingsScreen.tsx',
    'Change Description': 'BL-025 (Sprint 4): Added Export Contacts to CSV button in Premium Features card. exportDone state shows success feedback for 2.5s.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:00',
    'Screen / File': 'src/i18n/index.ts',
    'Change Description': 'BL-025 (Sprint 4): Added i18n keys settings_exportContacts + settings_exportSuccess in EN+HE.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:30',
    'Screen / File': 'src/components/Navigation.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Back button in PageHeader changed to min-w/h-[48px] flex items-center justify-center — 48×48px minimum tap target.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:30',
    'Screen / File': 'src/screens/ContactFormScreen.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Delete icon button in ContactForm PageHeader changed to min-w/h-[48px] tap target.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:30',
    'Screen / File': 'src/screens/GroupsScreen.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Edit and Delete icon buttons on group cards changed to min-w/h-[48px] tap targets.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:30',
    'Screen / File': 'src/screens/GreetingEditorScreen.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Regenerate and Copy icon buttons changed to min-w/h-[48px] tap targets.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:30',
    'Screen / File': 'src/components/ui/Modal.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Close (X) button in Modal header changed to min-w/h-[48px] tap target.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:30',
    'Screen / File': 'src/screens/ContactDetailScreen.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Edit icon button in ContactDetail PageHeader changed to min-w/h-[48px] tap target.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '00:30',
    'Screen / File': 'src/screens/HolidayDetailScreen.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Copy greeting icon button changed to min-w/h-[48px] tap target.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    Date: '2026-04-29',
    Time: '00:30',
    'Screen / File': 'src/screens/premium/BirthdayGreetingEditorScreen.tsx',
    'Change Description': 'BL-029 (Sprint 4) WCAG 2.5.5: Regenerate and Copy icon buttons in BirthdayGreetingEditor changed to min-w/h-[48px] tap targets.',
    Type: 'improvement',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    Date: '2026-04-29',
    Time: '01:00',
    'Screen / File': 'src/services/hapticService.ts',
    'Change Description': 'BL-024 (Sprint 4): New hapticService with hapticLight/Medium/Success/Error. Uses Capacitor.isNativePlatform() guard — graceful no-op in browser. ImpactStyle.Light/Medium and NotificationType.Success/Error.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    Date: '2026-04-29',
    Time: '01:00',
    'Screen / File': 'src/screens/ContactFormScreen.tsx + src/components/ChannelPicker.tsx + src/screens/UpgradeScreen.tsx',
    'Change Description': 'BL-024 (Sprint 4): Haptic wired to 3 key actions — hapticSuccess after contact save, hapticMedium on greeting channel select, hapticSuccess/Error on coupon redemption.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '01:30',
    'Screen / File': 'src/services/storageService.ts',
    'Change Description': 'BL-034 (Sprint 4): exportBackupJSON() exports contacts+groups+drafts+settings as JSON with UTF-8 encoding; importBackupJSON() reads File and restores data after validation. Version and exportedAt metadata included.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '01:30',
    'Screen / File': 'src/screens/SettingsScreen.tsx',
    'Change Description': 'BL-034 (Sprint 4): Added Backup and Restore buttons to Premium Features card. Hidden file input for restore. Success reloads page after 1.2s. Error feedback clears after 3s.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '01:45',
    'Screen / File': 'src/screens/ContactFormScreen.tsx',
    'Change Description': 'BL-035 (Sprint 4): Duplicate contact detection on new contact creation. findDuplicate() checks exact name match or phone (7+ digits stripped). Modal warns with matching name and offers "Save Anyway" or "Cancel". Edit mode excluded.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
  },
  {
    ...
    Time: '01:45',
    'Screen / File': 'src/i18n/index.ts',
    'Change Description': 'BL-024+034+035: Added 13 i18n keys in EN+HE: settings_backupData/Success, settings_restoreData/Success/Error, contactForm_duplicateTitle/Body/SaveAnyway.',
    Type: 'feature',
    Category: 'code_change',
    Agent: 'Agent 1',
    Status: 'done',
