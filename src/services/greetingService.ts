  ...
  const templates: Record<GreetingTone, Partial<Record<Language, string[]>>> = {
    friendly: {
      ...
      hebrew: [
        ...
        "סתם חשבתי עליך ורציתי לדעת מה שלומך. מי יודע — אולי נסגור סוף סוף לפגוש? ☕",
        "הרבה זמן לא דיברנו! מקווה שהכל בסדר גמור. תעדכן/י אותי בחדשות! 🌟",
        "נזכרתי בך ורציתי להגיד שלום. איך אתה/את? מקווה שהכל מעולה 😊",
        "מה קורה? סתם חשבתי עליך ורציתי לאחל לך יום נפלא! כמה זמן לא דיברנו... 🌟",
        "הרבה זמן לא דיברנו — עלית לי בראש ורציתי להגיד שלום. שיהיה הכל טוב אצלך! 💙",
    ...
    business: {
      ...
      hebrew: [
        ...
        "פניתי לבדוק מה נשמע ולוודא שאנחנו מסונכרנים. מקווה שהכל מתקדם כמו שצריך.",
